...
{
    public class CodeDomTypeDeclaration<P> : CodeDomTypeDeclarationBase<CodeTypeDeclaration, P> where P : ICodeTypes
    {
        ...
        public Members.CodeDomTypeDeclaration<CodeDomTypeDeclaration<P>> BeginTypeDeclaration(string name)
        {
            return new Members.CodeDomTypeDeclaration<CodeDomTypeDeclaration<P>>(name, this);
        }
